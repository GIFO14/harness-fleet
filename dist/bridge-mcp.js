...
// packages/bridge-mcp/src/index.ts
import { McpServer } from "@modelcontextprotocol/sdk/server/mcp.js";
import { StdioServerTransport } from "@modelcontextprotocol/sdk/server/stdio.js";
import { z } from "zod";
var baseUrl = process.env.HARNESS_FLEET_URL;
var token = process.env.HARNESS_FLEET_TOKEN;
...
server.registerTool(
  "fleet_report",
  { description: "Orchestrator-only: generate the current fleet report", inputSchema: {} },
  async () => result(await call("/orchestrator/report"))
);
await server.connect(new StdioServerTransport());
//# sourceMappingURL=bridge-mcp.js.map